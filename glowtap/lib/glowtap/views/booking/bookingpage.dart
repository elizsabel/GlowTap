...
class _BookingpageState extends State<Bookingpage> {
  ...
  // ✅ FINAL confirm() sudah diperbaiki
  void confirm() async {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => BookingConfirmPage(
          ...
          customerPhone: customerPhone,             // ✅ dikirim ke Confirm
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Telp / WA: ${widget.doctorPhone}",
                            style: TextStyle(
                              fontSize: 13,
            ...
            inputField("Catatan (Opsional)", catatanC),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      "Pembayaran dilakukan ketika dokter datang (COD) ✨",
