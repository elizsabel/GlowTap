...
import 'package:glowtap/glowtap/firebase/splash_firebase/splashfirebase_page.dart';
import 'package:glowtap/glowtap/firebase/views/auth_firebase/login_firebase_page.dart';
import 'package:glowtap/glowtap/firebase/views/auth_firebase/register_firebase_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
  "/bottomFirebase": (_) => const BottomNavFirebase(),
  "/loginFirebase": (_) => const LoginCustFirebase(),
  "/registerFirebase": (_) => const RegisterCustFirebase(),
},
